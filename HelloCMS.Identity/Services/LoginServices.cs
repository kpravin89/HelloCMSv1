...
namespace HelloCMS.Identity.Services
{
    public class LoginServices : ILoginServices
    {
        ...
        public async Task<TokenResultDto?> LoginAsync(LoginDto loginVM)
        {
        ...
        /// <returns></returns>
        public async Task<TokenResultDto> VerifyAndGenerateTokenAsync(TokenRequestDto tokenRequestVM)
        {
        ...
        //Helper Methods
        private async Task<TokenResultDto> GenerateTokenAsync(AppIdentityUser appIdentityUser, RefreshToken? refreshToken)
        {
            ...
            {
                var rTokenResultVM = new TokenResultDto(jwtToken, refreshToken.Token, token.ValidTo);
            ...
            var response = new TokenResultDto(jwtToken, newRefreshToken.Token, token.ValidTo);
